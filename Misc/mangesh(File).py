# -*- coding: utf-8 -*-
"""
Created on Tue Jan 21 14:53:32 2020
...
handler = logging.FileHandler(r'C:\Users\achoud3\Desktop\Project\SellableUnit1\ETL_SellableUnit_SearsHierarchy_Data_' + str(datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S')) + '.log', mode='w')
